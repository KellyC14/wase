...
// ##
// ## Class to represent a LTI Data Connector with no data persistence for use with WASS
// ##
class LTI_Data_Connector_wase extends LTI_Data_Connector
{
    ...
    {
        if ($consumer->getKey() == WaseUtil::getParm('LTIKEY')) {
            $consumer->secret = WaseUtil::getParm('LTISECRET');
